...
public class LogoController {
    ...
    public Result setBbtt(@RequestParam("logoFile") MultipartFile multipartFile,SysLogo logo){
    ...
    public Result setSbbqtt(@RequestParam("logoFile") MultipartFile multipartFile,SysLogo logo){
