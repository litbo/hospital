  ...
  var settings = {}, roots = {}, caches = {},
    ...
    view = {
      ...
      makeNodeIcoStyle: function (setting, node) {
        ...
        if (!node.isAjaxing) {
          var isParent = data.nodeIsParent(setting, node);
          var icon = setting.view.loadIcon !== false && ( (isParent && node.iconOpen && node.iconClose) ? (node.open ? node.iconOpen : node.iconClose) : node[setting.data.key.icon] );
  ...
  var _consts = {
    ...
    _view = {
      ...
      addRemoveBtn: function (setting, node) {
        ...
        var aObj = $$(node, consts.id.A, setting),
          removeStr = "<span class='" + consts.className.BUTTON + " remove' id='" + node.tId + consts.id.REMOVE + "' title='" + tools.apply(setting.edit.removeTitle, [setting.treeId, node], setting.edit.removeTitle) + "' treeNode" + consts.id.REMOVE + " style='display:none;'><i class='fas fa-times'></i></span>";
